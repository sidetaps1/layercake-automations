...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Layer Cake AI — AI Automation for Modern Businesses" },
      {
        name: "description",
        content:
          "Layer Cake AI builds intelligent automation — lead generation, booking CRMs, email flows, marketing campaigns, and SEO — so your business runs itself.",
      },
      { name: "author", content: "Layer Cake AI" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-HBDMYTJ6GN" />
        <script
